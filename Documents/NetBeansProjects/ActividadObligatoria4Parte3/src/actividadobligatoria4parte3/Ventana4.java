...
public class Ventana4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Numero par o impar");
    ...
    private void botonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActionPerformed
        ...
        int number;
        number = Integer.parseInt(Numero.getText());
        
        if(number % 2 == 0){
            JOptionPane.showMessageDialog(null, number + " es par.");
        }
        else{
            JOptionPane.showMessageDialog(null, number + " es impar.");
        }
